...
if(COMPILING_CLIENT || COMPILING_OFFLINE) {
  ss2d.Sprite.prototype.render = "webgl" == RENDER_CONTEXT ? function(b) {
    if(this.mReady && (!this.mTextureAtlas || this.mTextureAtlas.mTextureElement)) {
...
ss2d.SkeletalSprite.prototype.playAnimation = function(b, c) {
  this.mCurrentAnimationTime = 0;
  this.mCurrentAnimationCallback = c;
  this.mCurrentAnimation = this.mAnimationsMap[b] || null
};
ss2d.SkeletalSprite.prototype.stopAnimation = function() {
  this.mCurrentAnimationTime = 0;
  this.mCurrentAnimationCallback = !1;
  this.mCurrentAnimation = null;
  this.setDefaultPose()
};
ss2d.SkeletalSprite.prototype.updateAnimation = function(b) {
  if(this.mCurrentAnimation && 0.01 < Math.abs(this.mTimeDilation)) {
    ...
    var c = !1;
    0 < this.mTimeDilation && this.mCurrentAnimationTime >= this.mCurrentAnimation.mDuration ? (this.mCurrentAnimationTime -= this.mCurrentAnimation.mDuration, c = !0) : 0 > this.mTimeDilation && 0 >= this.mCurrentAnimationTime && (this.mCurrentAnimationTime += this.mCurrentAnimation.mDuration, c = !0);
    c && this.mCurrentAnimationCallback && this.mCurrentAnimationCallback.call(this)
  }
  this.tickChildren(b);
