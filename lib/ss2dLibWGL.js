...
ss2d.ShaderProgram = function(b, c, d) {
  ...
  for(var h in d) {
    c = d[h], this.mAttributes[c] = e.getAttribLocation(this.mProgramId, c), e.enableVertexAttribArray(this.mAttributes[c])
  }
  ss2d.ShaderProgram.PROGRAM_IN_USE = null
};
ss2d.ShaderProgram.PROGRAM_IN_USE = null;
ss2d.ShaderProgram.prototype.use = function(b) {
  ss2d.ShaderProgram.PROGRAM_IN_USE != this && (b.useProgram(this.mProgramId), ss2d.ShaderProgram.PROGRAM_IN_USE = this)
};
ss2d.materials = {};
...
ss2d.RenderSupport = function(b) {
  ...
  "webgl" == RENDER_CONTEXT && (this.mMatrixStack = [], this.mCurrentMatrix = new ss2d.Matrix3, this.mColorStack = [], this.mCurrentColor = [1, 1, 1, 1], this.mActiveSampler = this.mActiveTexture = 0, b = this.mContext, b.blendFunc(b.SRC_ALPHA, b.ONE_MINUS_SRC_ALPHA), b.enable(b.BLEND), this.mBuffers = {}, this.mBuffers.mQuadVertexPosition = this.createBuffer(b.ARRAY_BUFFER, new Float32Array([0, 0, 1, 0, 1, 1, 0, 1]), 2, 4), this.mBuffers.mQuadTextureCoords = this.createBuffer(b.ARRAY_BUFFER, new Float32Array([0, 
  0, 1, 0, 1, 1, 0, 1]), 2, 4), this.mBuffers.mQuadVertexIndex = this.createBuffer(b.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), 1, 6), this.mMaterials = {}, this.mMaterials.mTextured = new ss2d.materials.Textured(this))
};
...
"webgl" == RENDER_CONTEXT && (ss2d.Texture.prototype.handleLoadedTexture = function(b) {
  try {
    var c = ss2d.CURRENT_VIEW.mContext;
    this.mTextureId = c.createTexture();
    c.bindTexture(c.TEXTURE_2D, this.mTextureId);
...
if(COMPILING_CLIENT || COMPILING_OFFLINE) {
  ss2d.Sprite.prototype.render = "webgl" == RENDER_CONTEXT ? function(b) {
    if(!(this.mTextureAtlas && -1 == this.mTextureAtlas.mTextureId) && (this.mTextureAtlas || -1 != this.mTexture.mTextureId)) {
      ...
      var d = b.mContext, e = b.mMaterials.mTextured, f = (new ss2d.Matrix3).scale(this.mWidth, this.mHeight).concatMatrix(this.getTransformationMatrix()).concatMatrix(this.getWorldTransformationMatrix(null, null)), g = new ss2d.Matrix3;
      if(this.mClip && 3 < this.mClip.length) {
        var h = c.mTextureElement.width, j = c.mTextureElement.height;
        g.scale(this.mClip[2] / h, this.mClip[3] / j);
        g.translate(this.mClip[0] / h, this.mClip[1] / j)
      }
      b.pushTransform(this);
      e.mModelViewMatrix = f;
      e.mColor = b.mCurrentColor;
