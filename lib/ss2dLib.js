...
ss2d.ClientView.prototype.nextFrame = function() {
  ...
  for(var d in this.mPreTickFunctions) {
    this.mPreTickFunctions[d].call(null, timePassedInSeconds)
  }
  this.updateSceneState(b, c / 1E3);
  for(d in this.mPostTickFunctions) {
    this.mPostTickFunctions[d].call(null, timePassedInSeconds)
  }
...
ss2d.ServerView.prototype.nextFrame = function() {
  var b = (new Date).getTime(), c = b - this.mLastFrameTimestamp, d;
