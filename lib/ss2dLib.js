...
ss2d.View.prototype.nextFrame = function() {
  ...
  this.mInput.tick(c / 1E3);
  this.mPhysicalWorld.tick(c / 1E3);
...
ss2d.Pickable.prototype.tick = function() {
  ...
  (this.mPicked = ss2d.Pickable.PICKED_COMPONENT == this && b.mMouseDown) ? (c = this.mOwner.worldToLocal(b.mMousePoint), this.mOwner.mLocation.mX = c.mX + this.mOffset.mX, this.mOwner.mLocation.mY = c.mY + this.mOffset.mY) : ss2d.Pickable.PICKED_COMPONENT == this && (ss2d.Pickable.PICKED_COMPONENT = null)
};
ss2d.DefaultConfig = {};
