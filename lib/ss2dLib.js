...
ss2d.ResourceManager.Loaders = {TEXTURE:ss2d.TextureLoader, SOUND:ss2d.AudioLoader, TEXTURE_ATLAS:ss2d.TextureAtlasLoader, BITMAP_FONT:ss2d.BitmapFont};
...
if(COMPILING_CLIENT || COMPILING_OFFLINE) {
  ss2d.BitmapTextSprite.prototype.render = function(b) {
    ...
    var c = b.mContext;
    try {
      for(var d = this.mWidth = 0;d < this.mTextString.length;++d) {
        var e = this.mTextString.charCodeAt(d);
        if(32 == e) {
          c.translate(this.mFontSize / this.mBitmapFont.mMidHeight * this.mBitmapFont.mMidWidth, 0)
        }else {
          this.mBitmapFont.getGlyphClip(e, this.mClip);
          var f = this.mFontSize / this.mBitmapFont.mMidHeight;
          c.scale(f, f);
          c.translate(0, this.mClip[5]);
          c.drawImage(this.mBitmapFont.mTexture.mTextureElement, this.mClip[0], this.mClip[1], this.mClip[2], this.mClip[3], 0, 0, this.mClip[2], this.mClip[3]);
          c.translate(0, -this.mClip[5]);
          c.translate(this.mClip[4], 0);
          c.scale(1 / f, 1 / f)
        }
      }
    }catch(g) {
...
COMPILING_CLIENT && (ss2d.BitmapTextSprite.convert = function(b) {
  ...
  var c = new ss2d.BitmapTextSprite(b.x, b.y, b.str, b.c, b.fsize, b.fname, b.fstyle);
  c.mObjectId = b.doid;
  return c
...
COMPILING_SERVER && (ss2d.BitmapTextSprite.prototype.toJSON = function() {
  ...
  var b = ss2d.Quad.prototype.getPropertiesJSON.call(this), b = b + (',"str": "' + this.mTextString + '"'), b = b + (',"fsize": "' + this.mFontSize + '"'), b = b + (',"fname": "' + this.mFontName + '"');
