...
if(COMPILING_CLIENT || COMPILING_OFFLINE) {
  ss2d.BitmapTextSprite.prototype.render = function(b) {
    ...
    try {
      ...
      for(var e = 0;e < this.mTextString.length;++e) {
        var f = this.mTextString.charCodeAt(e);
        32 == f ? c.translate(this.mBitmapFont.mMidWidth, 0) : (this.mBitmapFont.getGlyphClip(f, this.mClip), this.mGlyphSprite.mLocation.mX = d, this.mGlyphSprite.mLocation.mY = this.mClip[5], this.mGlyphSprite.mClip = this.mClip, this.mGlyphSprite.mWidth = this.mClip[2], this.mGlyphSprite.mHeight = this.mClip[3], this.mGlyphSprite.render(b), d += this.mClip[4])
      }
    }catch(g) {
    }
    b.popTransform()
