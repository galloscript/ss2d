...
ss2d.ResourceManager.Loaders = {TEXTURE:ss2d.TextureLoader, SOUND:ss2d.AudioLoader, TEXTURE_ATLAS:ss2d.TextureAtlasLoader, BITMAP_FONT:ss2d.BitmapFontLoader, REEL_SET:ss2d.ReelSetLoader};
...
ss2d.ResourceManager.loadResourceWithLoader = function(b, c, d, e) {
  ...
  f[g] || (f[g] = b.loadResource(c, d, e || null));
  return f[g]
};
...
ss2d.ReelSprite = function(b, c, d, e, f, g) {
  ...
  ss2d.ResourceManager.loadReelSet(f, this.setup, this)
};
...
if(COMPILING_CLIENT || COMPILING_OFFLINE) {
  ss2d.ReelSprite.prototype.tick = function(b) {
    ...
    if(this.mPlaying && this.mReelSet) {
      ...
      var c = this.mPlayingReel.getTimePerFrame() * this.mTimeDilation;
      this.mElapsedTimeCurrentFrame += b;
      if(this.mElapsedTimeCurrentFrame >= c && (this.mFrameCount += Math.floor(this.mElapsedTimeCurrentFrame / c), this.mElapsedTimeCurrentFrame -= c, this.mFrameCount >= this.mPlayingReel.mFrames.length && (this.mLoop ? this.mElapsedTimeCurrentFrame = this.mFrameCount = 0 : (this.mFrameCount--, this.mComplete = !0, this.mPlaying = !1)), b = this.mPlayingReel.mFrames[this.mFrameCount])) {
        b.dumpClip(this.mClip), this.mOffsetX = b.mOffsetX, this.mOffsetY = b.mOffsetY
      }
    }
