...
ss2d.RigidBody.prototype.reset = function() {
  ...
  switch(this.mBodyType) {
    case ss2d.RigidBody.Types.BOX:
      ...
      var d = new ss2d.Point(this.mOwner.mLocation.mX, this.mOwner.mLocation.mY), d = this.mOwner.localToWorld(d);
...
ss2d.BitmapTextSprite = function(b, c, d, e, f) {
  ...
  if(COMPILING_CLIENT || COMPILING_OFFLINE) {
    this.mGlyphSprite = new ss2d.Sprite, this.mClip = []
  }
};
  ...
  ss2d.BitmapTextSprite.prototype.render = function(b) {
    ...
    try {
      ...
      for(var e = -1 < this.mDisplayChars ? Math.min(this.mDisplayChars, this.mTextString.length) : this.mTextString.length, f = 0;f < e;++f) {
        ...
        32 == g ? c.translate(0.5 * this.mBitmapFont.mMidWidth, 0) : (this.mBitmapFont.getGlyphClip(g, this.mClip), this.mGlyphSprite.mLocation.mX = d, this.mGlyphSprite.mLocation.mY = this.mClip[5], this.mGlyphSprite.mClip = this.mClip, this.mGlyphSprite.mWidth = this.mClip[2], this.mGlyphSprite.mHeight = this.mClip[3], this.mGlyphSprite.render(b), d += this.mClip[4])
      }
    }catch(h) {
    }
    b.popTransform()
...
ss2d.PhysicalWorld.prototype.createMouseJoint = function(b) {
  ...
  md.body2 = b;
  md.target.Set(c.mMouseX, c.mMouseY);
  md.maxForce = 1E3 * b.m_mass;
...
ss2d.Pickable.prototype.tick = function() {
  ...
  if(b.mMouseDown && !b.mPreviousMouseDown && this.mOwner.hitTestPoint(b.mMousePoint)) {
    ss2d.Pickable.PICKED_COMPONENT && (ss2d.Pickable.PICKED_COMPONENT.mPicked = !1);
  ...
  (this.mPicked = ss2d.Pickable.PICKED_COMPONENT == this && b.mMouseDown) ? this.mMoveObject && (c = this.mOwner.worldToLocal(b.mMousePoint), this.mOwner.mLocation.mX = c.mX + this.mOffset.mX, this.mOwner.mLocation.mY = c.mY + this.mOffset.mY) : ss2d.Pickable.PICKED_COMPONENT == this && (ss2d.Pickable.PICKED_COMPONENT = null)
};
ss2d.DefaultConfig = {};
