  ...
  ss2d.BitmapTextSprite.prototype.render = function(b) {
    ...
    try {
      ...
      for(var e = -1 < this.mDisplayChars ? Math.min(this.mDisplayChars, this.mTextString.length) : this.mTextString.length, f = 0;f < e;++f) {
        ...
        32 == g ? c.translate(0.5 * this.mBitmapFont.mMidWidth, 0) : (this.mBitmapFont.getGlyphClip(g, this.mClip), this.mGlyphSprite.mClip = this.mClip, this.mGlyphSprite.mWidth = this.mClip[2], this.mGlyphSprite.mHeight = this.mClip[3], this.mDisplacement.mX = d, this.mDisplacement.mY = this.mClip[5], this.displacement(f, g, d, this.mClip[5], this.mDisplacement), this.mGlyphSprite.mLocation.mX = this.mDisplacement.mX, this.mGlyphSprite.mLocation.mY = this.mDisplacement.mY, this.mGlyphSprite.render(b), 
        d += this.mClip[4])
      }
      this.mWidth = d;
