...
ss2d.Pickable.prototype.tick = function() {
  ...
  if(b.mMouseDown && !b.mPreviousMouseDown && this.mOwner.hitTestPoint(b.mMousePoint)) {
    ss2d.Pickable.PICKED_COMPONENT && (this.mRigidBody && this.mMouseJoint && (ss2d.PhysicalWorld.getWorld().mWorld.DestroyJoint(this.mMouseJoint), this.mMouseJoint = null), ss2d.Pickable.PICKED_COMPONENT.mPicked = !1);
