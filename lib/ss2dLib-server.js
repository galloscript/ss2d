...
var XML = {};
"undefined" == typeof XML && (XML = function() {
});
...
ss2d.Pickable.prototype.tick = function() {
  var b = ss2d.CURRENT_VIEW.mInput;
  b.mMouseDown && !b.mPreviousMouseDown && this.mOwner.hitTestPoint(b.mMousePoint) && (ss2d.Pickable.PICKED_COMPONENT && (ss2d.Pickable.PICKED_COMPONENT.mPicked = !1), ss2d.Pickable.PICKED_COMPONENT = this, this.mPicked = !0, this.mOffset.set(this.mOwner.mLocation.mX - b.mMouseX, this.mOwner.mLocation.mY - b.mMouseY));
  (this.mPicked = ss2d.Pickable.PICKED_COMPONENT == this && b.mMouseDown) ? (this.mOwner.mLocation.mX = b.mMouseX + this.mOffset.mX, this.mOwner.mLocation.mY = b.mMouseY + this.mOffset.mY) : ss2d.Pickable.PICKED_COMPONENT == this && (ss2d.Pickable.PICKED_COMPONENT = null)
};
ss2d.DefaultConfig = {};
