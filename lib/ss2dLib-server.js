...
if(COMPILING_CLIENT || COMPILING_OFFLINE) {
  ss2d.ReelSprite.prototype.tick = function(b) {
    ...
    if(this.mPlaying && this.mReelSet) {
      ...
      this.mElapsedTimeCurrentFrame >= c && (this.mFrameCount += Math.floor(this.mElapsedTimeCurrentFrame / c), this.mElapsedTimeCurrentFrame -= c, this.mFrameCount >= this.mPlayingReel.mFrames.length && (this.mLoop ? this.mElapsedTimeCurrentFrame = this.mFrameCount = 0 : (this.mFrameCount--, this.mComplete = !0, this.mPlaying = !1)), b = this.mPlayingReel.mFrames[this.mFrameCount], b.dumpClip(this.mClip), this.mOffsetX = b.mOffsetX, this.mOffsetY = b.mOffsetY)
    }
