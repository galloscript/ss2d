...
ss2d.ReelFrame = function(a, b, c, d, e, f, g) {
  ...
  this.mOffsetX = f || 0;
  this.mOffsetY = g || 0;
  this.mTexture = e instanceof ss2d.Texture ? e : ss2d.ResourceManager.loadTexture(e)
};
...
if(COMPILING_CLIENT || COMPILING_OFFLINE) {
  ss2d.Sprite.prototype.render = function(a) {
    ...
    a.pushTransform(this);
    var c = a.mContext;
    b && (4 == this.mClip.length ? c.drawImage(b, this.mClip[0], this.mClip[1], this.mClip[2], this.mClip[3], 0, 0, this.mWidth, this.mHeight) : c.drawImage(b, 0, 0, this.mWidth, this.mHeight));
    a.popTransform()
  }
}
...
ss2d.RenderSupport.prototype.pushTransform = "webgl" == RENDER_CONTEXT ? function(a) {
  ...
  this.mAuxMatrix.identity();
  var b = a.getTransformationMatrix(this.mAuxMatrix);
  this.mContext.save();
